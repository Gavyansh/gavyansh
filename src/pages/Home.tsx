          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-12">
            {[
              ...
              >
                ...
                <h3 className="font-serif text-lg md:text-xl font-bold mb-2">{feature.title}</h3>
      ...
      <section className="py-24 bg-ghee-warm/30">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <h2 className="text-3xl md:text-4xl font-serif font-bold mt-4">Premium Vedic Products</h2>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col lg:flex-row items-center gap-16">
            <div className="lg:w-1/2">
              ...
              <h2 className="text-3xl md:text-4xl font-serif font-bold mt-4 mb-8">Why Choose A2 Desi Ghee?</h2>
